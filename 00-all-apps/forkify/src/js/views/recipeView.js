...
class RecipeView {
  ...
  #getTemplate() {
    return `
      <figure class="recipe__fig">
        <img src="${this.#recipe.imageUrl}" alt="${this.#recipe.title}" class="recipe__img" />
      ...
      <div class="recipe__ingredients">
        ...
        <ul class="recipe__ingredient-list">
          ${this.#recipe.ingredients.map(this.#generateIngredientTemplate).join('')}
        </ul>
      </div>
      ...
      <div class="recipe__directions">
        ...
        <a class="btn--small recipe__btn" href="${this.#recipe.sourceUrl}" target="_blank">
  ...
  #generateIngredientTemplate(ing) {
    return `
