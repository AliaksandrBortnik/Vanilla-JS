...
// to the object as a new property. Forumla: recommendedFood = weight ** 0.75 * 28. (The result is in grams of food, and
...
const isDogEatingEnough = dog => dog.curFood >= dog.recommendedFood * 0.9 && dog.curFood <= dog.recommendedFood * 1.1;
console.log(dogs.some(isDogEatingEnough));

// 7. Create an array containing the dogs that are eating an OKAY amount of food (try to reuse the condition used in 6.)
const dogsHaveEnoughFood = dogs.filter(isDogEatingEnough);

// 8. Create a shallow copy of the dogs array and sort it by recommended food portion in an ascending order (keep in mind that the portions are inside the array's objects)
const copiedDogs = dogs.slice(); // [...dogs]
copiedDogs.sort((a, b) => a.recommendedFood - b.recommendedFood);